...
<html lang="en">
    ...
    <body class="@yield('body-class','page-index')" data-spy="scroll" data-target=".main-menu">
        <!--====== Start Preloader ======-->
        <div class="preloader">
            <div class="loader">
        ...
        @include('website-creative-layout.header2')
        ...
        @include('website-creative-layout.footer')
