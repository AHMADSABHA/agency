                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input name="blog_id" type="number"
                                            ...
                                            placeholder="Enter blog_id" value="{{ old('blog_id') }}">
                                        @error('blog_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tag" type="text"
                                            ...
                                            placeholder="Enter tag" value="{{ old('tag') }}">
                                        @error('tag')
                                            <span id="exampleInputEmail1-error"
                                                class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="date_blog">date_blog</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="disc" class="form-control @error('disc') is-invalid  @enderror" id="disc"
                                            placeholder="Enter disc">{{ old('disc') }}</textarea>
                                        @error('disc')
                                            <span id="exampleInputEmail1-error"
                                                class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input name="sub_image" type="file"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="disc2" class="form-control @error('disc2') is-invalid  @enderror" id="disc2"
                                            placeholder="Enter disc2">{{ old('disc2') }}</textarea>
                                        @error('disc2')
                                            <span id="exampleInputEmail1-error"
                                                class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
