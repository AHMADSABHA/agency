            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="footer-logo mb-40 wow fadeInLeft">
                        <img src="{{ asset('assets/images/logo/footer-logo-1.png') }}" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget footer-nav-widget mb-40 wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <ul class="widget-nav">
                            <li><a href="{{ route('services.view') }}">UX/UI Design</a></li>
                            <li><a href="{{ route('services.view') }}">Web Development</a></li>
                            <li><a href="{{ route('services.view') }}">SEO Optimization</a></li>
                            <li><a href="{{ route('services.view') }}">Product Design</a></li>
                            <li><a href="{{ route('services.view') }}">Logo Design</a></li>
                            <li><a href="{{ route('services.view') }}">Brand Design</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget footer-nav-widget mb-40 wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <ul class="widget-nav">
                            <li><a href="{{ route('services.view') }}">About Agency</a></li>
                            <li><a href="{{ route('services.view') }}">Latest News & Blog</a></li>
                            <li><a href="{{ route('services.view') }}">Meet The Team</a></li>
                            <li><a href="{{ route('services.view') }}">Popular Services</a></li>
                            <li><a href="{{ route('services.view') }}">Testimonials</a></li>
                            <li><a href="{{ route('services.view') }}">Need a Career?</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="footer-nav float-lg-right">
                        <ul>
                            <li><a href="{{ route('services.view') }}">Setting & Privacy </a></li>
                            <li><a href="{{ route('services.view') }}">Faqs</a></li>
