        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="img-holder mb-50 wow fadeInLeft">
                    <div class="shape shape-one animate-float-y"><span><img src="{{ asset('assets/images/shape/shape-5.png') }}" alt=""></span></div>
                    <img src="{{ asset('assets/images/about/about-3.jpg') }}" alt="">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="text-wrapper mb-50 wow fadeInRight">
                    ...
                    <a href="{{ route('aboutus.view') }}" class="main-btn bordered-btn btn-blue">Learn More Us</a>
                </div>
            </div>
        </div>
    </div>
