    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="team-item mb-55 wow fadeInUp" data-wow-delay="{{ $loop->iteration*10 }}">
                    ...
                    <div class="text text-center">
                        ...
                        <h4><a href="{{ route('teamdetails.view',['id'=>$item->id]) }}">{{ $item->name }}</a></h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="button-box text-center wow fadeInUp">
                    <a href="{{ route('ourteam.view') }}" class="main-btn arrow-btn">View All Member</a>
                </div>
            </div>
        </div>
    </div>
