            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-item mb-40 wow fadeInUp" data-wow-delay=".25s">
                    <div class="entry-content">
                        ...
                        <h3 class="title"><a href="{{ route('blogs-details.view') }}">Everything You Want To Know About</a></h3>
                        <p>Sit amet consectete adipising elit 
                            wedo eiusmod temeidiunt laboret dolore magna ways</p>
                        <a href="{{ route('blogs-details.view') }}" class="btn-link">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-item mb-40 wow fadeInUp" data-wow-delay=".30s">
                    <div class="entry-content">
                        <a href="#" class="cat-btn">Design</a>
                        <h3 class="title"><a href="{{ route('blogs-details.view') }}">Designing Better Links For Websites And Emails</a></h3>
                        <p>Sit amet consectete adipising elit 
                            wedo eiusmod temeidiunt laboret dolore magna ways</p>
                        <a href="{{ route('blogs-details.view') }}" class="btn-link">Read More</a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="button-box text-center wow fadeInUp">
                    <a href="{{ route('blogs.view') }}" class="main-btn arrow-btn">View More News</a>
                </div>
            </div>
        </div>
    </div>
