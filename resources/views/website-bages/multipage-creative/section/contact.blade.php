        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <div class="img-holder mb-50 wow fadeInRight">
                    <div class="shape shape-icon-one scene"><span data-depth="1"><img src="{{ asset('assets/images/shape/shape-4.png') }}" alt=""></span></div>
                    <div class="shape shape-icon-two"><span></span></div>
                    <img src="{{ asset('assets/images/contact/contact-1.jpg') }}" alt="Contact Image">
                </div>
            </div>
        </div>
    </div>
